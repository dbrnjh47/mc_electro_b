                                ...
                                <div class="cart_block_product_list__line">
                                    ...
                                    <div class="cart_block_product_list__action">
                                        <div class="input_count">
                                            ...
                                            <input type="text" value="{{ $product->pivot->count }}" placeholder="1" class="input_count__input">
                                        ...
                                        <div class="cart_block_product_list__price">
                                            <div>
                                                <span class="price_old">{{ $product->getPriceText() }} руб.</span>
                                                <span class="price_current">{{ $product->getPriceText(($product->mrp * $product->pivot->count)) }} руб.</span>
                                            </div>
