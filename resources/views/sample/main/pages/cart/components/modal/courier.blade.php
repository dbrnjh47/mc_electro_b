        ...
        <div class="modal__body">
            <div class="modal_shipping__info">
                ...
                <div class="modal__input_wrapper invalid_feedback_wrapper">
                    ...
                    <input name="city" @if($cart->courier) value="{{ $cart->courier->city }}" @elseif($user_city && $user_city->name) value="{{ $user_city->name }}" @endif type="text" placeholder="Введите город" class="modal__input"
