        ...
        <div class="categories__container">
            <div class="app__title">
                <div class="app__title_wrapper">
                    <h2 class="app__title_text">Поиск</h2>

                    <p class="app__title_description">{{ request()->query('search') }}</p>
    ...
    <section class="category__container">
        <div class="category">
            ...
            @if ($properties->isNotEmpty())
                <div id="sticky_aside1" class="filter__wrapper dop_menu">
                    <div class="filter">
                        ...
                        <input type="text" name="search" value="{{ request()->query('search') }}" placeholder="Поиск"
                            class="input">
            ...
            <div class="products__wrapper" id="sticky_article">
                ...
                <section class="pagination__wrapper @if (!$html_products) skeleton @endif">
                    @if ($html_products)
                        {!! $html_products['paginate'] !!}
                    @endif
                </section>
            </div>
        </div>
